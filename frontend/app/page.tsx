...
const stats = [
  ...
  { value: "~10 min", label: "Avg. interview" },
];
...
export default function HomePage() {
  return (
    <div className="flex flex-col">
      ...
      {/* Hero */}
      <section className="flex flex-col items-center justify-center text-center px-6 py-28 border-b border-[#e5e5e5]">
        <h1 className="text-7xl font-bold tracking-tighter text-[#0a0a0a] mb-5">
          prep
        </h1>
      ...
      <section className="border-b border-[#e5e5e5]">
        <div className="max-w-6xl mx-auto px-6 py-14 grid grid-cols-3 divide-x divide-[#e5e5e5]">
          {stats.map((s) => (
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 w-full">
        <p className="text-xs text-neutral-400 uppercase tracking-widest mb-10">How it works</p>
